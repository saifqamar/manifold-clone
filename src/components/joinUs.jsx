...
export default function JoinUsSec(props){
    return(
        <div className={props.isBorder ? "joinUs-sec flex flex-col lg:flex-row lg:justify-between  mt-4 lg:mt-8 mx-4 lg:mx-8 p-8 lg:p-20 border border-neutral-700" : "joinUs-sec flex flex-col lg:flex-row lg:justify-between  mt-4 lg:mt-8 mx-4 lg:mx-8 p-8 lg:p-20"}>
            <div className="sec-img w-[400px] h-auto self-end lg:w-1/2">
                <img src="https://manifold.xyz/assets/about-join-us.c9d8e504.svg" alt="joinus img" />
            </div>
