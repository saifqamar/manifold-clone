...
export default function RCard(props){
    return(
        <div className={props.reverse ? "rcard lg:flex  lg:flex-row-reverse lg:w-full relative " : "card w-full relative "}>
            ...
            <div className={props.reverse ? "det-reverse lg:flex lg:flex-col  lg:justify-center lg:w-1/2 px-8 py-11 lg:py-20 lg:px-16 z-30" : "det lg:flex lg:flex-col lg:w-1/2 px-8 py-11 lg:py-20  z-30"}>
